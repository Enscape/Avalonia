...
namespace Avalonia.Controls
{
    ...
    public class DatePickerPresenter : PickerPresenterBase
    {
        ...
        public DatePickerPresenter()
        {
            ...
            MinYear = new DateTimeOffset(now.Year - 100, 1, 1, 0, 0, 0, now.Offset);
            MaxYear = new DateTimeOffset(now.Year + 100, 12, 31, 0, 0, 0, now.Offset);
            Date = now;
        ...
        static DatePickerPresenter()
        {
            ...
            DateProperty.Changed.AddClassHandler<DatePickerPresenter, DateTimeOffset>((s, e) => s.OnDateChanged(e.NewValue.Value));
            MaxYearProperty.Changed.AddClassHandler<DatePickerPresenter>(OnDateRangeChanged);
            MinYearProperty.Changed.AddClassHandler<DatePickerPresenter>(OnDateRangeChanged);
        }
