...
namespace Avalonia.Controls
{
    ...
    public class DatePicker : TemplatedControl
    {
        ...
        public static readonly StyledProperty<DateTimeOffset> MaxYearProperty =
            AvaloniaProperty.Register<DatePicker, DateTimeOffset>(nameof(MaxYear), coerce: CoerceMaxYear);

        /// <summary>
        /// Defines the <see cref="MinYear"/> Property
        /// </summary>
        public static readonly StyledProperty<DateTimeOffset> MinYearProperty =
            AvaloniaProperty.Register<DatePicker, DateTimeOffset>(nameof(MinYear), coerce: CoerceMinYear);
        ...
        static DatePicker()
        {
            DayVisibleProperty.Changed.AddClassHandler<DatePicker>(OnGridVisibilityChanged);
            MonthVisibleProperty.Changed.AddClassHandler<DatePicker>(OnGridVisibilityChanged);
            YearVisibleProperty.Changed.AddClassHandler<DatePicker>(OnGridVisibilityChanged);

            MaxYearProperty.Changed.AddClassHandler<DatePicker, DateTimeOffset>((s, e) => s.OnMaxYearChanged(e.NewValue.Value));
            MinYearProperty.Changed.AddClassHandler<DatePicker, DateTimeOffset>((s, e) => s.OnMinYearChanged(e.NewValue.Value));

            SelectedDateProperty.Changed.AddClassHandler<DatePicker, DateTimeOffset?>((s, e) => s.OnSelectedDateChanged(e));
        }
        ...
        private void OnSelectedDateChanged(AvaloniaPropertyChangedEventArgs<DateTimeOffset?> e)
        {
            SetSelectedDateText();
            OnSelectedDateChanged(this, new DatePickerSelectedValueChangedEventArgs(e.OldValue.Value, e.NewValue.Value));
        }
